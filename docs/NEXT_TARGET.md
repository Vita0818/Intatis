...
## 目标：完成 v0.40 Developer ID 直接分发候选

把当前 v0.40 源码收敛为可验证、可安装、可直接分发的 macOS ZIP/DMG；不走 App Store。
...
- 当前仓库文档已重新划分为当前规范和历史证据，README/状态/测试不再以旧 v0.9/v0.16
  里程碑冒充当前版本。
- Xcode 工程已重新生成，v0.40 版本一致性门已通过；macOS universal Release 与 iOS
...
- 不把历史 v0.10/v0.16 文档批量改名为 v0.40；它们是历史证据。
