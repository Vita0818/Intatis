...
- Cowork 链路：`Packages/IntatisCowork/Sources/Orchestrator.swift`、`AgentPermissionResponder.swift`、`MessageBus.swift`、`Mediator.swift`、`CoordinatorTools.swift`、`AskAgentTool.swift`
